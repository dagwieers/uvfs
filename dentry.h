...
/* dentry.h -- dentry operations */

#ifndef _UVFS_DENTRY_H_
#define _UVFS_DENTRY_H_

#include <linux/fs.h>

extern int uvfs_dentry_revalidate(struct dentry* entry);

#endif /* !_UVFS_DENTRY_H_ */
